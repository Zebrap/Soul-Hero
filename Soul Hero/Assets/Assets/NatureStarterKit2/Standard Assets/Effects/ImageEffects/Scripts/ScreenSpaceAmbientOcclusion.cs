...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ScreenSpaceAmbientOcclusion : MonoBehaviour
    {
        ...
        void Start()
        {
            if (!SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat.Depth)) // if (!SystemInfo.supportsImageEffects || !SystemInfo.SupportsRenderTextureFormat (RenderTextureFormat.Depth))
            {
                m_Supported = false;
                enabled = false;
                return;
